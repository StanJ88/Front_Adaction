...
CREATE TABLE `volunteers` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_id` (`city_id`),
  CONSTRAINT `volunteers_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `City` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

INSERT INTO `volunteers` (`id`, `firstname`, `lastname`, `mail`, `password`, `city_name`, `created_at`, `updated_at`) VALUES
